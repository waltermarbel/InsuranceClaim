        ...
        <div className="space-y-3">
            ...
            {items.map((item, i) => (
                <div key={i} className="flex gap-2 group">
                    ...
                    />
                    <button aria-label="Delete entry" onClick={() => deleteItem(i)} className="self-start mt-2 p-1.5 text-slate-300 hover:text-rose-500 hover:bg-rose-50 rounded-md transition-colors opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2">
        ...
        <div className="space-y-3">
            ...
            {entries.map(([key, value], i) => (
                <div key={i} className="flex gap-2 group items-center">
                    ...
                    <button aria-label="Delete entry" onClick={() => deleteItem(key)} className="p-2 text-slate-300 hover:text-rose-500 hover:bg-rose-50 rounded-md transition-colors opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2">
                        <TrashIcon className="h-4 w-4"/>
                    </button>
                </div>
            ))}
