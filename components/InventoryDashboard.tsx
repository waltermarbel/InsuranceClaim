...
const InventoryDashboard: React.FC<InventoryDashboardProps> = ({ 
    ...
    const tableData = useMemo(() => {
        // Bolt Performance Optimization: Extract search string outside loop to avoid O(n) re-lowercasing
        const searchLower = searchTerm?.toLowerCase() || '';

        // Bolt Performance Optimization: Single-pass filter loop (O(n) instead of O(6n))
