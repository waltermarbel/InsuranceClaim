...
const InventoryDashboard: React.FC<InventoryDashboardProps> = ({ 
    ...
    const tableData = useMemo(() => {
        // Bolt Optimization: Replace multiple array allocations from chained .filters with a single pass
        // and pre-calculate search term to avoid redundant processing.
