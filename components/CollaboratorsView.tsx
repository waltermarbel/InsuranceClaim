                                ...
                                <div className={`p-4 border-b ${person.type === 'TRUSTED' ? 'bg-emerald-50/50 border-emerald-100' : 'bg-amber-50/50 border-amber-100'}`}>
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex gap-1">
                                            <button onClick={() => handleEdit(person)} className="p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg">
                                                <PencilIcon className="h-4 w-4" />
                                            </button>
                                            <button onClick={() => handleDelete(person.id)} className="p-1.5 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-lg">
                ...
                <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                            ...
                            <button onClick={() => setIsModalOpen(false)} className="text-slate-400 hover:text-slate-600"><XIcon className="h-5 w-5"/></button>
                        </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-800 text-white shrink-0">
                            ...
                            <button onClick={() => setIsEmailModalOpen(false)} className="p-2 hover:bg-slate-700 rounded-full transition"><XIcon className="h-5 w-5"/></button>
                        </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-indigo-900 text-white shrink-0">
                            ...
                            <button onClick={() => setIsPlanModalOpen(false)} className="p-2 hover:bg-indigo-800 rounded-full transition"><XIcon className="h-5 w-5"/></button>
                        </div>
