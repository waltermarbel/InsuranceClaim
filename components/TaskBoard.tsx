                ...
                <div className="flex flex-col gap-2">
                    <div className="flex gap-2">
                        ...
                        <button 
                            ...
                            aria-label="Add task"
                            title="Add task"
                            className="bg-primary text-white p-2 rounded-lg hover:bg-primary-dark transition disabled:opacity-50 shadow-sm flex-shrink-0 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                        >
