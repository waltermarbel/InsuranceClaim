            ...
            <div className="flex-grow overflow-y-auto p-4 space-y-2 min-h-[150px]">
                {filteredTasks.length === 0 ? (
                    ...
                    filteredTasks.map(task => {
                        ...
                        return (
                            <div key={task.id} className="group flex items-start gap-3 p-3 rounded-lg border border-slate-100 hover:border-primary/30 hover:bg-slate-50/50 focus-within:opacity-100 transition-all">
                                <button 
                                    ...
                                    className={`flex-shrink-0 mt-0.5 w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary ${task.isCompleted ? 'bg-emerald-500 border-emerald-500 text-white' : 'border-slate-300 hover:border-primary'}`}
                                >
                                ...
                                <button 
                                    ...
                                    title="Delete task"
                                    className="text-slate-300 hover:text-rose-500 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-rose-500 rounded transition-opacity"
                                >
