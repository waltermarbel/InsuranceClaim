            ...
            <div className="flex-grow overflow-y-auto p-4 space-y-2 min-h-[150px]">
                {filteredTasks.length === 0 ? (
                    ...
                    filteredTasks.map(task => {
                        ...
                        return (
                            <div key={task.id} className="group flex items-start gap-3 p-3 rounded-lg border border-slate-100 hover:border-primary/30 hover:bg-slate-50/50 focus-within:border-primary/30 focus-within:bg-slate-50/50 focus-within:opacity-100 transition-all">
                                <button 
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex gap-2">
                        ...
                        <button 
                            ...
                            className="bg-primary text-white p-2 rounded-lg hover:bg-primary-dark transition disabled:opacity-50 shadow-sm flex-shrink-0 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-2"
                            aria-label="Add task"
                            title="Add task"
                        >
