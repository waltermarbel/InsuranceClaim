                        ...
                        {timeline.map((event) => (
                            ...
                            >
                                ...
                                <div className="flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity self-start">
                                    <button aria-label="Edit event" onClick={() => handleEdit(event)} className="p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg focus-visible:ring-2 focus-visible:outline-none">
                                        <PencilIcon className="h-4 w-4" />
                                    </button>
                                    <button aria-label="Delete event" onClick={() => handleDelete(event.id)} className="p-1.5 text-slate-400 hover:text-rose-500 hover:bg-rose-50 rounded-lg focus-visible:ring-2 focus-visible:outline-none">
