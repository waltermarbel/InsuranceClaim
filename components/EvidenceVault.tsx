    ...
    return (
        <>
            ...
            <button 
                ...
                className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity flex items-center justify-center text-white focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none"
