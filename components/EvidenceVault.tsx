    ...
    return (
        <>
            ...
            <button 
                ...
                aria-label="View Image" className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none transition-opacity flex items-center justify-center text-white"
            >
