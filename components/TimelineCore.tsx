        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-slate-50 p-6 rounded-xl border border-slate-200">
            ...
            <div className="lg:col-span-1 space-y-4">
                <div className="flex justify-between items-center bg-white p-3 rounded-lg shadow-sm">
                    ...
                    <button onClick={handleAddEvent} aria-label="Add new event" title="Add new event" className="p-1 bg-primary text-white rounded hover:bg-primary-dark transition"><PlusIcon className="h-4 w-4"/></button>
                </div>
